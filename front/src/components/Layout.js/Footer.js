  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Button
            style={{ color: "#5E5B52", minWidth: "0", padding: "0" }}
            size="100px"
        ...
        <p style={{ fontSize: "15px", color: "#5E5B52", textAlign: "center" }}>
          법인명: 또래올래 주식회사 | 통신판매업신고번호 : 0000-서울강남-00000 /
          사업자등록번호: 000-00-00000 | 대표자 : 코딩 순 서울특별시 강남구
          영동대로 421, 9층 삼탄빌딩 (대치동) 06182 | 대표번호 000-123-4567 |
          info.kr@.com
        </p>
        <p style={{ fontSize: "15px", color: "#5E5B52", textAlign: "center" }}>
